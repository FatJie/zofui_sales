    ...
    install(Vue){
        ...
        Vue.prototype.$util = { //全局方法
            ...
            Murl : function(doo,op){
                var url = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168') >= 0 ? 'http://127.0.0.5/app/index.php?i=4&c=entry&do=index&op=self&m='+this.const.module : location.href;
            ...
            upimg(file,fn){
                ...
                var url = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168.0') >= 0 ? 'http://127.0.0.5/app/index.php?i=4&c=entry&do=index&op=self&m='+this.const.module : location.href;
                var host = location.href.indexOf('http://127.0.0.1:8080') >= 0 || location.href.indexOf('http://192.168') >= 0 ? '192.168.0.109' : window.location.host;
                var param = this.getQuery(url);
