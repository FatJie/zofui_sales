...
<script type="text/javascript">
	import { Loading,List,Toast,Dialog,Popup,Field,cellGroup,Radio,radioGroup,Picker,Checkbox,CheckboxGroup,Cell,Uploader,Tab,Tabs,DatetimePicker,Calendar } from 'vant';
	export default {
        name : 'adminpub',
	  	components: {
	    	[List.name] : List,
