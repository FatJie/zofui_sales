<template>
    ...
    <div class="page"  >
        ...
        <div class="orderinfo_data">
            ...
            <div class="data_item item_cell_box">
                ...
                <div class="total_money" >¥ {{order.jiesuan}}</div>
            </div>
            <div class="data_item item_cell_box">
                <div class="item_cell_flex">让利金额</div>
                <div class="total_money" >¥ {{order.rangli}}</div>
            </div>
            ...
            <div class="data_item item_cell_box" v-if="good.type!=8">
        ...
        <div v-if="order.log" class="mt20 orderinfo_log">
            <div v-for="(item,index) in order.log" :key="index" class="log_item item_cell_box">
        ...
        <div v-if="hexiao.length > 0" class=" orderinfo_log">
            <div v-for="(item,index) in hexiao" :key="index" class="log_item item_cell_box">
    ...
    <div class="footer_box" >
        <div class="item_cell_box order_foot">
            ...
            <div class="bot_btn"  @click="bindtap($event,'tel')" :data-tel="order.tel ? order.tel : ''" >联系买家</div>
