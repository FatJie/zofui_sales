                ...
                <template v-else>
                    ...
                    <template v-else>
                        ...
                        <van-cell-group>
                            ...
                            <!-- <van-field clickable  label="到期时间" readonly :placeholder="join.end ? join.end : '设置时间'" @click="endtime = true" ></van-field> -->
        ...
        activated:function(e){
	  	...
	  	methods: {
            ...
            pass(e){
                ...
                var self = this;
                var uid=self.user.id;
                var join = JSON.stringify( {...self.join,uid:uid} );
