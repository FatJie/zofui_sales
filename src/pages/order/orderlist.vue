            ...
            <template v-if="datalist.length > 0">
                ...
                <div class="order-list">
                    <div class="item" v-for="item in datalist" >
                        ...
                        <div class="mes thin-border_b" @click="link" :data-url="item.appurl" :data-status="item.statusstr">
                            <div class="pic-box ">
	...
	export default {
        name : 'orderlist',
	  	...
	  	methods: {
            ...
            link(e){
                console.log(e)
            	this.$router.push({path:e.currentTarget.dataset.url,query:{status:e.currentTarget.dataset.status}});
            },
            tabChange(index){
                var self = this;
