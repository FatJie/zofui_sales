        ...
        <div id="content" v-if="inited == 2 && params.shopsty == 1">
            ...
            <div class="shop-t">
                <div class="shop-pic">
                    <div class="info-swiper act-swiper" >
                        <img v-lazy="shop.cover" style="width:100%;height:340px;">
                    </div>
                </div>
            ...
            <div>
                <div class="info-section">
                    ...
                    <div class="spaybtn lbg-pri" @click="toOlinepay" v-if="shop.onlinepay == 1">
                        在线买单
                        <!-- <font v-if=" shop.zhekou != 100 ">(低至{{shop.zhekou}}折)</font> -->
                    </div>
            ...
            <div class="shop-index-wrapper" >
                ...
                <div class="wrapper">
                    <div class="panel shop top">
                        <div class="content">
                            <div class="shop-info dis-flex flex-middle">
                                ...
                                <div class="tag-wrap vertical flex-middle flex-center">
                                    ...
                                    <div style="margin-bottom: 2px;" class="num num-style">{{shop.times}}</div>
                        ...
                        <!-- <div class="spaybtn lbg-pri" @click="link" :data-url="'/onlinepay?shopid='+shop.id" v-if="shop.isshowpay == 0 && params.shoppay == 0">
                            {{shop.spcut > 0 && shop.spcut < 10 ? shop.spcut*100/100  +'折' : '优惠'}}买单
                        </div> -->
                        <div class="spaybtn lbg-pri" @click="toOlinepay"  v-if="shop.onlinepay == 1">
                            在线买单
                            ...
                            <div class="shop-content">
                                <div class="shop-position-wrap" v-for="item in fendian" :key="item.id">
                                    <div class="dis-flex flex-between flex-middle">
                                        <div class="position">
                                            <font class="name" style="font-weight:bold;color: #333;">{{item.name}}</font>
                                    ...
                                    <div class="open-time dis-flex flex-middle" v-if="item.id == 0 && shop.severtime">
                                        <div class="text" style="margin-right: 3px;">
                                            营业时间：
                                        </div>
                            ...
                            <div class="goods-item" v-for="(item,index) in datalist" :key="index">
                                ...
                                <div @click="link" :data-url="item.appurl" class="defalut-goods-wrapper dis-flex" >
                                    ...
                                    <div class="item-right dis-flex flex vertical flex-between">
                                        ...
                                        <div style="display:flex;align-items:center;justify-content:space-between;font-size:0.36rem;margin-top:5px;">
                                            <div style="width:1rem;height:0.5rem;text-align:center;line-height:0.5rem;background:#fb2d37!important;color:#fff;border-radius:3px;">
                                                <font v-if="item.type==0">精选</font>
                                                <font v-if="item.type==1">抢购</font>
                                                <font v-if="item.type==2">拼团</font>
                                                <font v-if="item.type==8">特权</font>
                                                <font v-if="item.type==9">礼包</font>
                                            </div>
                                            <div style="color:#999;">已售:{{item.saled}}</div>
                                        </div>
                                        <div class="price-info dis-flex flex-middle flex-between" style="margin-top:-20px;">
                                            <div class="price flex" >
                                                <div>
                                                    <font class="now-price">￥{{item.show_price}}</font>
                                                    <font class="before-price " v-if="item.oldprice*1 > 0">￥{{item.oldprice}}</font>
                                                    <font class="eran-price " v-if="item.type!=8">赚￥{{item.money}}</font>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
	...
	export default {
        ...
        beforeRouteLeave(to, from, next){
	  	...
	  	methods: {
            toOlinepay(){
                this.$router.push({path:'/onlinepay',query:{uid:this.shop.uid,shopid:this.shop.id}})
            },
            onRefresh(){
                this.initData();
            },
