                ...
                <div class="main-list">
                    <div class="item thin-border_b" @click="link" :data-url="item.appurl" v-for="item in datalist" :class="listtype ? 'widthfull' : ''">
                        ...
                        <div class="btm">
                            ...
                            <div class="btm-bs">
                                <div class="btm-info" style="display: flex;justify-content: space-between;">
                                    ...
                                    <div style="color: #999;font-size: 0.32rem;">{{item.distance}}</div>
                                    <!-- <div class="btm_saled" >{{item.ncon}}：{{item.saled}}</div> -->
                                </div>
                                <div style="display: flex;justify-content: space-between;margin-top: 0.2rem;">
                                    <div class="btm_fx bg-pri">赚{{item.show_fx}}</div>
                                    <div class="btm_saled" >{{item.ncon}}：{{item.saled}}</div>
                                </div>
                            </div>
                        </div>
