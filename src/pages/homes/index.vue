<template>
	...
	<div :class="params.style"  id="page" >
	        	...
	        	<div id="content" >
                    ...
                    <div class="i-search" :style="{'padding-top':itemout.params.paddingv+'px','padding-bottom':itemout.params.paddingv+'px','background-color':itemout.params.bgcolor}" v-if="itemout.name == 'search'">
                        <div class="index_locimgs item_cell_box" @click="locCity" v-if="params.iscity == 2 || params.iscity == 0">
                            <div class="index_locimg">
                                <img src="http://ykd.lsh199.com/attachment/images/global/arrow.png" />
                            </div>
                            <div class="index_locname">{{locname ? locname : ''}}</div>
                        </div>
                        ...
                        <div @click="link" class="" data-url="/sortindex">商品分类</div>
                    </div>
                                ...
                                <div class="diy-list">
                                    <div v-for="item in itemout.params.data" :key="item.id" class="item thin-border_b" @click="link" :data-url="item.appurl" >
                                        ...
                                        <div class="btm">
                                                ...
                                                <div class="btm-info">
                                                    <div class="btm_price fmt-price">
                                                        <div class="now color-pri">
                                                            ...
                                                            <font class="price">{{item.show_price <= 0 ? '' : item.show_price}}</font>
                                                        </div>
                                            ...
                                            <div style="width:100%;margin-top:0.1rem;display: flex;justify-content: space-between;">
                                                <div class="btm_saled" >{{item.ncon}}：{{item.saled}}</div>
                                                <div style="width:1.6rem;height:0.6rem;border-radius: 0.3rem;background: #fb2d37;color: #fff;font-size:0.32rem;line-height: 0.6rem;text-align: center;">立即购买</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
								  	...
								  	<van-swipe-item v-for="item in itemout.params.data" :key="item.id" @click="link" :data-url="item.appurl" >
                                        <div class="item thin-border" @click="link" :data-url="item.appurl">
                                            <div class="top">
                                                ...
                                                <!-- <div class="list-status" :class="{'__saled':item.status == 1,'__end':item.status == 3}" v-if="item.status > 1"></div> -->
                                                <div class="top_countdown" v-if="item.uptime">
                                                    距结束
                                            ...
                                            <div class="btm">
                                                ...
                                                <div style="width:100%;margin-top:0.1rem;display: flex;justify-content: flex-end;">
                                                    <!-- <div class="btm_saled" >{{item.ncon}}：{{item.saled}}</div> -->
                                                    <div style="width:1.6rem;height:0.6rem;border-radius: 0.3rem;background: #fb2d37;color: #fff;font-size: 0.32rem;line-height: 0.6rem;text-align: center;">立即购买</div>
                                                </div>
                                            </div>
                            ...
                            <div class="diy-list">
                                <div v-for="item in itemout.params.data" :key="item.id" class="item thin-border_b" @click="link" :data-url="item.appurl" >
                                    ...
                                    <div class="btm">
                                        ...
                                        <div style="width:100%;margin-top:0.1rem;display: flex;justify-content: flex-end;">
                                            <!-- <div class="btm_saled" >{{item.ncon}}：{{item.saled}}</div> -->
                                            <div style="width:1.6rem;height:0.6rem;border-radius: 0.3rem;background: #fb2d37;color: #fff;font-size: 0.32rem;line-height: 0.6rem;text-align: center;">免费领取</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="btm-info">
                                                <div class="btm_price fmt-price">
                                                    <div class="now color-pri">
                                                        ...
                                                        <font class="price">{{item.show_price*1 <= 0 ? '' : item.show_price}}</font>
                                                    </div>
        ...
        <div class="kefu" style="width:1.4rem ;height: 1.4rem;position: fixed;right: 5px;top:67%;z-index: 5;">
            <img src="http://ykd.lsh199.com/attachment/images/global/mobile/index_kefu.png" @click="showqun=true" style="width: 100%;height: 100%;">
        </div>
                ...
                <div class="infopop-wrap">
                    <div class="infopop-content">
                        <div class="info-orderpay">
                            <img style="width: 100%;" src="https://img11.360buyimg.com/ddimg/jfs/t1/40356/11/8583/21826/5cff1f05Ebcd60c9a/e1f88171888c30a4.png">
                            <div class="area">
                                <div class="txt">
                                    <img src="http://ykd.lsh199.com/attachment/images/4/2020/06/Eo2z4LKthZg72JeE2VJ4K2FAwVh8hv.jpg" style="width:100%;">
                                </div>

                            </div>
                        </div>
                    </div>
                    <div @click="showqun=false" class="infopop-close">
                        <font class="iconfont">x</font>
                    </div>
                </div>
            </div>
        </div>
	...
	export default {
        ...
        methods: {
            ...
            changecity(e){
                ...
                self.$util.setCache('idd', e.currentTarget.dataset.id);
                self.$util.http('user','GET',postdata,function(res){
                    for (var i = 0; i < self.citylist.length; i++) {
            ...
            initData(){
                ...
                self.$util.http('index','GET',postdata,function(res){
                    ...
                    if( res && !res.errno ){
                        ...
                        self.$util.setCache('idd',self.actcity.pid);
                    ...
                    self.inited = 2;
                    if(res.data.userinfo.parent==0 || !res.data.userinfo.parent){
                        self.$router.push('/bindrecommend');
                    }
                });
            },
            onLoad() {
                var self = this;
                // if(!self.page.pdata.lat || !self.page.pdata.lng){
                //     self.$util.getLocation(function(){},self.params.tenkey,wx)
                // };
                // if( loc.lat ) {
                //     self.page.pdata.lat=loc.lat;
                // }
