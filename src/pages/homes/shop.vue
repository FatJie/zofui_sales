<template>
    <div id="main">
        ...
        <div v-if="inited == 2">
            ...
            <div class="search">
                <form action="/">
                    <van-search v-model="value" shape="round" placeholder="请输入店铺名..." @search="onSearch" background="#fff"/>
                </form>
            </div>
            <!--  分类导航栏   -->
            <div class="content">
                <van-tabs @click="onClick" :sticky="scrolltabs?true:false">
                    <van-tab v-for="index in tabs"  :key="index.id" :title="index.name" title-style="width:1rem">
                        ...
                        <van-swipe :autoplay="3000" indicator-color="white" v-if="swipes">
                            <van-swipe-item>
                                <img class="swipe_img" src="http://ykd.lsh199.com/attachment/images/global/mobile/shop_carousel(2).png">
                            </van-swipe-item>
                            <!-- <van-swipe-item>
                                <img class="swipe_img" src="http://ykd.lsh199.com/attachment/images/global/mobile/shop_carousel(1).png">
                            </van-swipe-item> -->
                        </van-swipe>
                        <!-- 筛选 -->
                                ...
                                <div class="shop_item" v-for="(item,index) in list" :key="index">
                                    <div @click="toShop(item.appurl)" style="display: flex;">
                                        ...
                                        <div class="first_right">
                                            ...
                                            <div class="shop_class"  v-if="item.promise == 1">保障</div>
                                            <div class="shop_class"  v-if="item.onlinepay == 1">买单</div>
                                            <div class="shop_class"  v-if="item.chain == 1">连锁</div>
                                            <!-- <div class="rate">
