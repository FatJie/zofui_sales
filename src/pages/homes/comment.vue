<template>
    ...
    <div :class="params.style" id="main">
            ...
            <template v-if="showtype == 0">
                ...
                <div class="content" >
                    ...
                    <div class="cont_kuai"  v-for="(item,index) in datalist" >
                        ...
                        <div class="cont_kuai_down" v-if="item.img && item.img.length>0">
        ...
        <router-link to="/page?id=195">
            <div style="width: 1.4rem;height: 1.4rem;position: fixed;top:30%;right: 5px;">
                <img style="width: 100%;height: 100%;" src="http://ykd.lsh199.com/attachment/images/global/mobile/newer.png">
            </div>
        </router-link>
    </div>
