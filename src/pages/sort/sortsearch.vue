    ...
    <div :class="params.style" id="main">
        ...
        <div id="content" v-if="inited == 2">
            ...
            <div class="search-wrap">
                <!-- <form action="get" @submit.prevent="confirm" target="_self"> -->
                    <div class="search-area" :style="{top:dev == 'app' ? '60px':0}">
                        ...
                        <form action="/" style="width:100%;">
                            <van-search v-model="page.pdata.key" shape="round" placeholder="请输入要搜索的店铺名称" @search="confirm" background="#fff"/>
                        </form>
                                ...
                                <div class="btm-info">
                                    <div class="btm_price fmt-price">
                                        <div class="now color-pri">
                                            ...
                                            <font class="price">{{item.show_price > 0 ? item.show_price : '免费领取'}}</font>
                                        </div>
...
<script type="text/javascript">
	import { Loading,Toast,List,PullRefresh,Search } from 'vant';
	...
	export default {
        name : 'aboutindex',
	  	...
	  	methods: {
            ...
            confirm(e){
                var self = this;
                if( !self.page.pdata.key || self.page.pdata.key == '' ) {
                    self.$toast('搜索内容为空，请重新输入！')
                }else{
                    this.datalist = [];
                    this.page.pdata.page = 1;
                    this.page.isend = false;
