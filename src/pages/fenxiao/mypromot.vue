        ...
        <div id="content" v-if="inited == 2">
            ...
            <div class="user-top">
                ...
                <div class="detial">
                    ...
                    <div class="item">
                        本月收入
                        <div class="num">{{dataInfo.month_income}}</div>
                    </div>
                    <div class="item" v-if="userinfo.grade > 1">
                        直推订单
                        <div class="num">{{dataInfo.zhituiorder}}</div>
                    </div>
                    <div class="item" v-if="params.isucard == 0 && userinfo.grade > 1">
                        直推店铺
                        <div class="num">{{dataInfo.zhituishop}}</div>
                    </div>
                </div>
            </div>
            <div class="user-list wrap" style="width:9.35rem !important;background: #fff;">
                <div class="item thin-border_b">
                    ...
                    <div class="info">{{dataInfo.gross_income}}元</div>
                </div>
                <div class="home" style="width:100%;display: flex;justify-content: space-between;text-align: center;font-size:0.38rem ;color: #1e1e1e;">
                    <div class="team" style="width:50%;padding:0.5rem 0;">
                        <div class="team_num" style="width:100%;">{{dataInfo.shopnum}}</div>
                        <div class="team_font" style="width:100%;">门店总数(家)</div>
                    </div>
                    <div v-if="userinfo.grade > 1" class="shop" style="width:50%;padding:0.5rem 0;color: #FF6E40;">
                        <router-link to="/profitshop">
                            <div class="team_num" style="width:100%;">{{dataInfo.quanyinum}}</div>
                            <div class="team_font" style="width:100%;">权益店铺(家)</div>
                        </router-link>
                    </div>
                </div>
