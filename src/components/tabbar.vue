	...
	export default {
        ...
        methods : {
            ...
            getPath(){
                ...
                var adminlist = ['adminindex','adminmoney','adminorder','adminorderinfo','adminset','adminsignin','admingoods','admindraw','adminbadmin','adminbhelplist','adminjifenadd','adminjifenlog','adminjifengive','cardredbag','admincardlog','adminmine','adminshop'];
            ...
            hideBar(){
                var hidelist = ['codeextention','page','aboutindex','adminlogin','extension2','referrals','addcard','memberbag','extension','onlineposter','onlinepaying','onlinepay','bindrecommend','poster','mypromot','buyserver','speciallist','bindphone','upgrade','codechange','mymembers','memberdetail','shopincome','rundata','editshop','shopverify','editstaff','staffmanage','suretixian','tixian','chooseshop','specialinfo','hexiaodone','specialdetail','finelist','login','goodinfo','shopinfo','cardmyinfo','jiziinfo','adminbindadmin','adminhexiao','adminhexiaocard','commentinfo','orderinfo','mymoney','jifengoods','signinfo','zhuanpan','redbaginfo','commentorder','orderaddaddress','orderconfirm','orderaddress','groupinfo','agentjoin','adminpay','fenxiaoinvite_shop','buycard','adminsignin','cardinfo','adminpub','agentinvite','adminbaddcard','adminbcard','adminset','fenxiaojoinPartner','kefuindex','vedioindex','art','yhminfo','questinfo','goodsshare','addshopmoney','topay','openserver','cashdetails','agent','profitshop','shopdetails','shopprofit','shopenter','reddetails','freeshop','shopsuccess','pubgood','pubspecial','myconnection','shoplist'];
