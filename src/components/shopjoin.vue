...
<div v-if="!params.isjoin || params.isjoin == 0">
    <div  bindtap="params.jointype == 0  ? 'navigateto' : 'showJoin'" @click="showJoin(params.jointype)" class="shop-join" data-url="/shopenter" :data-tel="params.jointel" :data-copy="params.joinwx">
